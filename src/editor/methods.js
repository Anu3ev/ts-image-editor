...
export default ({ editorOptions }) => ({
  ...
  //   this.resetZoom()
  //   this.canvasManager.setResolutionWidth(editorOptions.montageAreaWidth, { withoutSave: true })
  //   this.canvasManager.setResolutionHeight(editorOptions.montageAreaHeight, { withoutSave: true })
  //   this.canvas.renderAll()
